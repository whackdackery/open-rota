...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        String error = "No request handler found for " + ex.getHttpMethod() + " " + ex.getRequestURL();
    ...
    public ResponseEntity<Object> entityNotFound(Exception ex, WebRequest request) {
        var api404 = new Api404(ex.getLocalizedMessage());
        return new ResponseEntity<>(api404, new HttpHeaders(), api404.getStatus());
    }

    @ExceptionHandler({ValidationException.class})
    public ResponseEntity<Object> validationError(ValidationException ex, WebRequest request) {
        List<String> errors = ex.errors.stream()
    ...
    public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
        var apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getLocalizedMessage(), "Unhandled error occurred");
        return new ResponseEntity<>(
                apiError, new HttpHeaders(), apiError.getStatus());
    }
}
